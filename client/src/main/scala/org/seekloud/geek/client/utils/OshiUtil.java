...
//      : firmware.getReleaseDate() == null ? "unknown" : FormatUtil.formatDate(firmware.getReleaseDate())));
  ...
  private static void printMemory(GlobalMemory memory) {
    System.out.println("已使用内存: " + FormatUtil.formatBytes(memory.getAvailable()) + "总共内存"
...
//    System.out.println(procCpu.toString());
  ...
  private static void getCPUMemInfo() {
  ...
  public static void main(String[] args) {
    System.out.println(Loader.load(org.bytedeco.ffmpeg.ffmpeg.class));
//    Logger LOG = LoggerFactory.getLogger(OshiUtil.class);
